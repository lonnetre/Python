...
if __name__ == "__main__":
    ...
    ###############################
    register("a", "Aufgabe 1a: Hallo, Welt!", 0.5, "hallo_welt",
             imports=[],
             calls=[
                 (("hallo_welt",), None, "Hallo, Welt!")
             ])
    register("b", "Aufgabe 1b: Hallo, Lisa!", 0.5, "hallo_welt",
             imports=[],
             calls=[
                 # Surprise #1: Apparently everything that is a string gets
                 #              evaluated, meaning that real strings have to be
                 #              parameterized by "double" strings.
                 (("hallo_name", "'Lisa'"), None, "Hallo, Lisa!"),
                 (("hallo_name", "'Anna'"), None, "Hallo, Anna!"),
                 (("hallo_name", "'Jan'"), None, "Hallo, Jan!"),
                 (("hallo_name", "'Magdalena'"), None, "Hallo, Magdalena!"),
             ])
    register("c", "Aufgabe 1c: Main-Funktion!", 0, "hallo_welt",
             imports=[],
             calls=[])
