...
if __name__ == "__main__":
    ...
    ###############################
    register("a", "Aufgabe 3a: Exponentialfunktion", 0.25, "float",
             calls=[
                 (("my_exp", 0.0), 1.0),
                 (("my_exp", 1.0), 2.7182818284590455),
                 (("my_exp", 2.0), 7.389056098930649),
                 (("my_exp", -1.0), 0.36787944117144245),
             ])

    register("b", "Aufgabe 3b: Numerische Differentiation, diff1", 0.25, "float",
             calls=[
                 (("diff1", "(lambda x:2.0*x)", 0.0, 1.0), 2.0),
                 (("diff1", "(lambda x:2.0*x)", -1.0, 2.0), 2.0),
                 (("diff1", "(lambda x:-2.0*x)", -1.0, 1.0), -2.0),
                 (("diff1", "(lambda x:2.0*x+5)", 1.0, 1.0), 2.0),
                 (("diff1", "(lambda x:x**2)", 0.0, 1e-8), 0.0),
                 (("diff1", "(lambda x:x**2)", 1.0, 1e-8), 2.0),
                 (("diff1", "(lambda x:x**2)", -1.0, 1e-8), -2.0),
                 (("diff1", "(lambda x:x**2)", 2.0, 1e-8), 4.0),
                 (("diff1", "(lambda x:x**3)", 1.0, 1e-8), 3.0),
             ])

    register("c", "Aufgabe 3b: Numerische Differentiation, diff2", 0.25, "float",
             calls=[
                 (("diff2", "(lambda x:2.0*x)", 0.0, 1.0), 2.0),
                 (("diff2", "(lambda x:2.0*x)", -1.0, 2.0), 2.0),
                 (("diff2", "(lambda x:-2.0*x)", -1.0, 2.0), -2.0),
                 (("diff2", "(lambda x:2.0*x+5)", 1.0, 2.0), 2.0),
                 (("diff2", "(lambda x:x**2)", 0.0, 1.0), 0.0),
                 (("diff2", "(lambda x:x**2)", 1.0, 1.0), 2.0),
                 (("diff2", "(lambda x:x**2)", -1.0, 1.0), -2.0),
                 (("diff2", "(lambda x:x**2)", 2.0, 1.0), 4.0),
                 (("diff2", "(lambda x:x**3)", 1.0, 1e-8), 3.0),
             ])

    register("d", "Aufgabe 3c: Quadratwurzeln (schwer)", 0.25, "float",
             calls=[
                 (("sqrt", 20.0), 4.47213595499958),
                 (("sqrt", 22.75), 4.769696007084728),
                 (("sqrt", 24.5), 4.949747468305833),
                 (("sqrt", 9.0), 3.0),
                 (("sqrt", 20.5), 4.527692569068709),
                 (("sqrt", 46.0), 6.782329983125269),
                 (("sqrt", 36.5), 6.041522986797286),
                 (("sqrt", 5.25), 2.29128784747792),
                 (("sqrt", 56.75), 7.533259586659682),
                 (("sqrt", 48.75), 6.982120021884471),
                 (("sqrt", 52.5), 7.245688373094719),
                 (("sqrt", 14.5), 3.8078865529319543),
                 (("sqrt", 49.75), 7.053367989832944),
                 (("sqrt", 73.75), 8.587782018658835),
                 (("sqrt", 24.5), 4.949747468305833),
                 (("sqrt", 17.75), 4.2130748865881795),
             ])
